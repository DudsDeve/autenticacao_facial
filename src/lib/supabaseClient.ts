...
// Aceita também seu nome com "UPABASE" como fallback, se existir.
const url =
    (import.meta as any).env.VITE_SUPABASE_URL ||
    (import.meta as any).env.VITE_UPABASE_URL || // caso tenha escrito "UPABASE" no .env
    'https://esslddxlhdwfbgxhzpso.supabase.co';
